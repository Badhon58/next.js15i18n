...
const Payment = async (Order: paymentdata) => {
  ...
  const signData = {
    ...
    currency: "BDT",
    bill_to_forename: Order.user.firstName,
    bill_to_surname: Order.user.lastName,
    bill_to_email: Order.user.email,
    bill_to_phone: Order.user.phone,
