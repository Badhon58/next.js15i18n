...
const RegisterUser = () => {
  ...
  return (
    <div className="xl:container xl:mx-auto mt-2 min-h-[68vh] flex  items-center justify-center">
      <section className="bg-white p-8 rounded-lg shadow-[6px_6px_25px_0px_rgba(16,_40,_81,_0.11)] lg:w-[40%] md:w-[60%] sm:w-[80%] w-11/12">
        {/* otp Creation  */}
        {status == "create" && (
          <>
            <p className="text-2xl font-[550] text-center text-gray-600">
              {" "}
              {t("registration")}
            </p>
