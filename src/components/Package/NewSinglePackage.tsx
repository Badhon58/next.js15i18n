...
const NewSinglePackage = ({ data }: { data: Package }) => {
  ...
  return (
    <>
      <div
        className={`bg-[#FFF4F4] border min-w-[340px] lg:min-w-[315px] xl:min-w-[260px] 2xl:min-w-[360px] h-full flex flex-col rounded-[14px] ${
        ...
        <div className="p-3 text-justify flex-row h-full ">
          ...
          <div className="flex flex-col space-y-2 mt-2 min-h-[170px] 2xl:min-h-48">
            {data.title && data.title?.length > 0 && (
              <h3 className="flex items-center space-x-1.5 text-sm font-medium">
