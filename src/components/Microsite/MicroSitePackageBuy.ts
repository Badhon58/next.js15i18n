import { User } from "@/lib/LibInterface";
...
const MicroPackagePay = async (
  ...
  // const override_backoffice_post_url =
  //   "https://localhost:5000/api/admin/ebl/payment/callback";
  // const override_custom_cancel_page = "https://localhost:3000/cancel";
  // const override_custom_receipt_page = "https://localhost:3000/api/ebl-receipt";
  const override_backoffice_post_url = `${process.env.NEXT_PUBLIC_CLINICALL_SERVER_URL}/admin/ebl/payment/callback`;
  const override_custom_cancel_page = `${process.env.NEXT_PUBLIC_FRONTEND_URL}/api/micro-payment-failed`;
  const override_custom_receipt_page = `${process.env.NEXT_PUBLIC_FRONTEND_URL}/api/micro-receipt`;
  ...
  const signData = {
    ...
    reference_number: packageInfo.invoiceNumber,
    // reference_number: gift,
    auth_trans_ref_no: packageInfo.invoiceNumber,
