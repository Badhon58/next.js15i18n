...
export const POST = async (req: Request) => {
  ...
  if (decision === "ACCEPT") {
    const value = {
      ...
      auth_trans_ref_no: object.auth_trans_ref_no,
      ...
      isGift: object.req_reference_number === "true" ? true : false,
      auth_code: auth_code,
    };
